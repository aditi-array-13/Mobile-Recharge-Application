...
<%
    ...
    if (mobileno != null && service != null && amountStr != null) {
        try {
            ...
            isTransactionAdded = dao.addTransaction(transaction);
            isBalanceUpdated = dao.updateBalance(mobileno, -amount);
...
<body>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item"><a class="nav-link" href="Profile.jsp"
							style="background-color: white; border-radius: 50%"> <svg
	...
	<main class="container mt-5">
		...
		<div class="card p-3 mt-3">
			<% if (mobileno != null && service != null && amountStr != null && isTransactionAdded && isBalanceUpdated) { %>
			<div class="alert alert-success" role="alert">Recharge
				successful!</div>
			<p>
			...
			<p>
				...
				<%= amountStr %></p>
			<a href="Dashboard.jsp" class="btn btn-primary mt-3">Go to
				Dashboard</a>
			<% } else { %>
			<div class="alert alert-danger" role="alert">Recharge failed.
				Please try again.</div>
			<a href="Recharge.jsp" class="btn btn-secondary mt-3">Go back to
				Recharge</a>
			<% } %>
		</div>
	</main>
